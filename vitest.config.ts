...
const sourceAlias = {
  ...
  "@agent-chat-platform/core/testing": "packages/core/src/testing.ts",
  "@agent-chat-platform/auth": "packages/auth/src/index.ts",
  "@agent-chat-platform/core": "packages/core/src/index.ts",
  "@agent-chat-platform/chat-server": "packages/chat-server/src/index.ts",
  "@agent-chat-platform/chat-ui/shell": "packages/chat-ui/src/shell.tsx",
  "@agent-chat-platform/chat-ui/admin": "packages/chat-ui/src/admin.tsx",
  ...
  "@agent-chat-platform/client-assembly": "packages/client-assembly/src/index.ts",
