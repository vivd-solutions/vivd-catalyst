...
Every Vivd Catalyst deployment is a dedicated client instance. The main decision is who operates it.
...
Some systems remain outside Vivd Catalyst even when the instance is operated for the customer.
...
These are customer-hosted integrations. They are not part of the Vivd Catalyst runtime, but the instance must document how it authenticates to them, what data it sends, and what failures look like.
