...
const translations = {
  en: {
    ...
    previewApiError: "Preview could not be loaded",
    previewFailed: "Preview unavailable",
    previewFallbackFailed: "Browser preview could not be loaded",
    previewFallbackLoading: "Loading browser preview",
    previewLoading: "Loading preview",
    previewPagesFailed: "Preview images could not be loaded",
    previewPagesLoading: "Loading preview images",
    previewPending: "Preview is being prepared",
    previewPendingLong: "Preview is still queued",
    previewRefreshing: "Refreshing preview",
    previewUnavailable: "Preview unavailable",
    previewUnsupported: "Preview unavailable for this file",
  ...
  de: {
    ...
    previewApiError: "Vorschau konnte nicht geladen werden",
    previewFailed: "Vorschau nicht verfügbar",
    previewFallbackFailed: "Browser-Vorschau konnte nicht geladen werden",
    previewFallbackLoading: "Browser-Vorschau wird geladen",
    previewLoading: "Vorschau wird geladen",
    previewPagesFailed: "Vorschaubilder konnten nicht geladen werden",
    previewPagesLoading: "Vorschaubilder werden geladen",
    previewPending: "Vorschau wird vorbereitet",
    previewPendingLong: "Vorschau ist noch in der Warteschlange",
    previewRefreshing: "Vorschau wird aktualisiert",
    previewUnavailable: "Vorschau nicht verfügbar",
    previewUnsupported: "Vorschau für diese Datei nicht verfügbar",
