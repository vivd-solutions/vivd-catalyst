...
const translations = {
  en: {
    ...
    artifactPreviewPartial: "Showing the first {shown} of {total} pages.",
    ...
    contextAutomaticallyCompacted: "Context automatically compacted",
    contextIndicator: "Context indicator",
    contextIndicatorDescription: "Show current context usage beside the message composer.",
    contextPercentFull: "{percent}% full",
    ...
    resourcesAnalyses: "Analyses",
    resourcesClose: "Close Resources panel",
    resourcesCopyAll: "Copy all",
    resourcesCopyValue: "Copy value",
    resourcesCreatedFiles: "Created files",
    resourcesCustomerData: "Customer data",
    resourcesEmpty: "No resources in this conversation yet.",
    resourcesLoadFailed: "Resources could not be loaded.",
    resourcesLoading: "Loading resources…",
    resourcesSourceWithPage: "{filename}, page {page}",
    resourcesTitle: "Resources",
    resourcesToggle: "Toggle Resources panel",
    resourcesUnknownFileType: "Unknown file type",
    resourcesUploadedFiles: "Uploaded files",
    ...
    preparing: "Working…",
    preparingAlt1: "Going through everything…",
    preparingAlt2: "Taking a look…",
    preparingAlt3: "Making progress…",
    preparingAlt4: "Staying on it…",
    preparingAlt5: "On it…",
    preparingAlt6: "Working through it…",
    preparingAlt7: "Sorting out the details…",
    preparingAlt8: "Keeping at it…",
    preparingAlt9: "One moment…",
    preparingTool: "Preparing {tool}…",
    runningTool: "Working on {tool}…",
  ...
  de: {
    ...
    artifactPreviewPartial: "Die ersten {shown} von {total} Seiten werden angezeigt.",
    ...
    contextAutomaticallyCompacted: "Kontext automatisch komprimiert",
    contextIndicator: "Kontextanzeige",
    contextIndicatorDescription: "Zeigt die aktuelle Kontextnutzung neben dem Nachrichtenfeld.",
    contextPercentFull: "{percent} % voll",
    contextTokensUsed: "{used} / {limit} Tokens verwendet",
    ...
    resourcesAnalyses: "Analysen",
    resourcesClose: "Inhalte schließen",
    resourcesCopyAll: "Alles kopieren",
    resourcesCopyValue: "Wert kopieren",
    resourcesCreatedFiles: "Erstellte Dateien",
    resourcesCustomerData: "Kundendaten",
    resourcesEmpty: "Diese Unterhaltung enthält noch keine Inhalte.",
    resourcesLoadFailed: "Inhalte konnten nicht geladen werden.",
    resourcesLoading: "Inhalte werden geladen…",
    resourcesSourceWithPage: "{filename}, Seite {page}",
    resourcesTitle: "Inhalte",
    resourcesToggle: "Inhalte ein- oder ausblenden",
    resourcesUnknownFileType: "Unbekannter Dateityp",
    resourcesUploadedFiles: "Hochgeladene Dateien",
    ...
    thinking: "Denke nach",
    thinkingActivity: "Ich denke nach…",
    preparing: "Ich arbeite daran…",
    preparingAlt1: "Ich gehe alles durch…",
    preparingAlt2: "Ich schaue es mir an…",
    preparingAlt3: "Es geht voran…",
    preparingAlt4: "Ich bleibe dran…",
    preparingAlt5: "Ich kümmere mich darum…",
    preparingAlt6: "Ich arbeite mich durch…",
    preparingAlt7: "Ich sortiere die Details…",
    preparingAlt8: "Ich mache weiter…",
    preparingAlt9: "Einen Moment noch…",
    preparingTool: "Bereite {tool} vor…",
    runningTool: "Bearbeite {tool}…",
