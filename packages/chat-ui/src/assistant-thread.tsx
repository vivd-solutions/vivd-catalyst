...
export function AssistantThread({
  ...
  return (
    ...
    >
      ...
      >
        <ThreadPrimitive.Viewport className="chat-scrollbar relative flex min-h-0 flex-col overflow-y-auto overflow-x-hidden scroll-smooth pr-[min(var(--resources-inset,0px),max(0px,calc(var(--thread-max-width)+2*var(--resources-inset,0px)-100%)))] transition-[padding] duration-300 ease-out">
