...
export function AssistantThread({
  ...
  return (
    ...
    >
      ...
      >
        <ThreadPrimitive.Viewport className="chat-scrollbar relative flex min-h-0 flex-col overflow-y-auto overflow-x-hidden scroll-smooth pr-[var(--resources-inset,0px)] transition-[padding] duration-300 ease-out">
